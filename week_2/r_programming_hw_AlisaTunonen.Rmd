...
weather_forecast <- list(
                "Thursday" = list(temperature = 11, chance_of_rain = 10, wind_speed = 20),
                "Friday" = list(temperature = 12, chance_of_rain = 5, wind_speed = 11),
                "Saturday" = list(temperature = 13, chance_of_rain = 5, wind_speed = 7)
)
...
```{r}
weather_two_weeks <- matrix(c(11, 9, 10, 11, 12, 13, 10, 9, 13, 17, 16, 12, 11, 9),
nrow = 2, ncol = 7, byrow = TRUE)
```

```{r}
rownames(weather_two_weeks) <- c("week_1", "week_2")
colnames(weather_two_weeks) <- c("mon", "tue", "wed", "thur", "fri", "sat", "sun")

weather_two_weeks

weather_two_weeks[2,3]
weather_two_weeks[2,]
weather_two_weeks[1, c(1, 3, 5)]
weather_two_weeks[2, c(1, 3, 5)]
